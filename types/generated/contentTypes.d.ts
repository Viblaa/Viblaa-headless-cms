...
export interface ApiBuyerBuyer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    communication_preferences: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customer_since: Schema.Attribute.DateTime;
    date_of_birth: Schema.Attribute.Date;
    default_address: Schema.Attribute.Component<'shared.address', false>;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::buyer.buyer'> &
      Schema.Attribute.Private;
    loyalty_points: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
...
export interface ApiInfluencerInfluencer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    content_guidelines: Schema.Attribute.RichText;
    content_type_preferences: Schema.Attribute.Enumeration<
      ['posts', 'stories', 'videos', 'reels', 'live', 'articles', 'reviews']
    >;
    ...
    is_verified_creator: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    joined_date: Schema.Attribute.DateTime;
    ...
    > &
      Schema.Attribute.Private;
    media_kit: Schema.Attribute.Media<'files'>;
    niche_categories: Schema.Attribute.JSON;
    phone: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 20;
      }>;
    ...
    social_networks: Schema.Attribute.Component<'shared.social-network', true>;
...
export interface ApiVendorVendor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    rating: Schema.Attribute.Decimal &
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    return_policy: Schema.Attribute.RichText;
    shipping_policy: Schema.Attribute.RichText;
    ...
    total_sales: Schema.Attribute.BigInteger & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
